...
@section('seo_title', __('Add new BlogPost'))
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">@lang('Enter data for the new Blog Post')</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form 
                        role="form" 
                        action="{{route('admin.blog_posts.insert')}}" 
                        method="post" 
                        id="entity-form" 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div><strong> @lang('Author:') {{$user->name}}</strong></div>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $('#entity-form [name="blog_post_category_id"]').select2({
        ...
        "language": {
            "noResults": function () {
                return "There is no Blog Post category with that name"
            }}
    });
